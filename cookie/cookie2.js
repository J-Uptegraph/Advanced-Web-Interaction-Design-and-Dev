xdocument.addEventListener('DOMContentLoaded', function () {
    ...
    let checkToAllowAllCookies = document.createElement('checkbox');
    checkToAllowAllCookies.id = 'AllowAll';
    checkToAllowAllCookies.className = 'AllowAll';
    checkToAllowAllCookies.addEventListener("click",storeAllCookies);
    ...
    div.appendChild (checkToAllowAllCookies);
}, false);
